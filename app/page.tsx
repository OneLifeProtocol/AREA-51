...
export default function Home() {
  return (
    <main className="min-h-screen bg-gray-900 text-white">
      {/* ─── Navigation ─────────────────────────────────────────── */}
      <header className="sticky top-0 z-50 bg-gray-900/90 backdrop-blur-sm border-b border-gray-700/50">
        <div className="container mx-auto py-3 px-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex gap-10">
              <Link
                href="#"
                className="font-heading text-white/90 hover:text-orange-500 transition-colors text-xl font-bold [text-shadow:_0_0_10px_rgba(255,255,255,0.5)] hover:[text-shadow:_0_0_15px_rgba(255,255,255,0.8)]"
              >
                HOME
              </Link>
              <Link
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-12 leading-relaxed font-medium tracking-wide">
            ...
            <Link href="#contatti">
              <Button
                size="lg"
                className="bg-orange-500 hover:bg-orange-600 text-black text-xl md:text-2xl font-extrabold px-12 py-4 md:py-8 shadow-[0_0_15px_rgba(255,102,25,0.5)] transition-all hover:shadow-[0_0_20px_rgba(255,102,25,0.7)] hover:scale-105 animate-pulse-glow rounded-xl focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2"
              >
                PRENOTA ORA
              </Button>
            </Link>
      ...
      <section className="py-8 bg-gray-800/80 border-y border-gray-700/50 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="flex flex-col items-center gap-1">
              <span className="font-heading text-3xl font-extrabold text-orange-500">[500]+</span>
              <span className="text-white/60 text-sm">Clienti Soddisfatti</span>
            </div>
            <div className="flex flex-col items-center gap-1">
              <span className="font-heading text-3xl font-extrabold text-orange-500">[10]+</span>
              <span className="text-white/60 text-sm">Anni di Esperienza</span>
            </div>
            <div className="flex flex-col items-center gap-1">
              <span className="font-heading text-3xl font-extrabold text-orange-500 inline-flex items-center gap-1">
                [4.9] <Star className="w-5 h-5 fill-orange-500 text-orange-500" />
              </span>
              <span className="text-white/60 text-sm">Rating su Google</span>
            </div>
            <div className="flex flex-col items-center gap-1">
              <span className="font-heading text-3xl font-extrabold text-orange-500">[120]+</span>
              <span className="text-white/60 text-sm">Recensioni Verificate</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-white/70 text-sm">
                <div className="flex justify-between gap-4">
                  <span>Lun – Ven</span>
                  <span className="text-orange-500/80 font-medium">[9:00 – 19:00]</span>
                </div>
                <div className="flex justify-between gap-4">
                  <span>Sabato</span>
                  <span className="text-orange-500/80 font-medium">[9:00 – 18:00]</span>
                </div>
                <div className="flex justify-between gap-4">
                  <span>Domenica</span>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.instagram.com/salone-area-51"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.facebook.com/salone-area-51"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="text-white/70 hover:text-orange-500 transition-colors"
...
function ServiceCard({
  ...
  return (
    <Link href={link}>
      <Card className="relative bg-gray-800/50 border-gray-700 hover:bg-gray-800 transition-all hover:shadow-[0_0_25px_rgba(255,102,25,0.7)] active:shadow-[0_0_30px_rgba(255,102,25,0.9)] group cosmic-card cursor-pointer transform hover:scale-105 active:scale-95 overflow-hidden">
        ...
        <CardContent className="p-6 relative z-10">
          ...
          <CardDescription className="text-white/80 text-sm leading-relaxed mb-4 [text-shadow:_0_0_8px_rgba(0,0,0,1)]">
            {description}
          </CardDescription>
          <p className="text-orange-500 font-heading font-bold text-lg">{price}</p>
        </CardContent>
      </Card>
    </Link>
  )
